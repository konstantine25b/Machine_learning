...
class FullyConnectedNet(object):
    ...
    def loss(self, X, y=None):
        ...
        for l in range(self.num_layers):
            ...
            bn = self.bn_params[l] if l < self.num_layers-1 and self.normalization else None
        ...
        loss += 0.5 * self.reg * sum(np.sum(self.params[f'W{l+1}']**2) for l in range(self.num_layers))
        ...
        for l in reversed(range(self.num_layers)):
            ...
            if self.normalization and l < self.num_layers-1 and dgamma is not None:
